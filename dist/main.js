...
client.on("message", async (msg) => {
    if (changeRoleTest.test(msg.content)) {
        ...
        await msg.reply(`Ich weise dir die Sprachen zu, die du auf diesem Server auch sehen möchtest.
...
const decodeLangs = (x) => x.slice(6).split(",").map(lang => RoleIdByLang[lang]);
